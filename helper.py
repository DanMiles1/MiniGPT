...
embed_dim = 192
num_heads = 6
# feed_forward_dim updated in notebooks to 512, keeping that logic
feed_forward_dim = 512 
batch_size = 32 # updated in notebook 
num_epochs = 3
...
class MiniGPT(nnx.Module):
    # Updated to mark lists of modules as data via nnx.data() / nnx.List for latest flax.nnx versions.
    ...
    def __init__(self, maxlen=maxlen, vocab_size=vocab_size, embed_dim=embed_dim, num_heads=num_heads,
                 feed_forward_dim=feed_forward_dim, num_transformer_blocks=num_transformer_blocks, *, rngs: nnx.Rngs):
